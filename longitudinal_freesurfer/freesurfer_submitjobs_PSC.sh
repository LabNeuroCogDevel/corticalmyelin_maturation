...
for subject_id in "${participant_list[@]}"; do
   logfile=${project_dir}/logs/freesurfer7.4.1_long/${subject_id}-fsbids-7.4.1. #location and stem name for log file
   mkdir -p "$(dirname "$logfile")"

   # Don't submit this sub job if already running. TODO: confirm this will match running
