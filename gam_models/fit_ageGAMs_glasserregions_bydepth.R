...
run.gams.bydepth(input.depth.df = myelin.compartments.7T$superficial, output.df.name = "superficial_gamstatistics_age.RDS")
run.gams.bydepth(input.depth.df = myelin.compartments.7T$middle, output.df.name = "middle_gamstatistics_age.RDS")
run.gams.bydepth(input.depth.df = myelin.compartments.7T$deep, output.df.name = "deep_gamstatistics_age.RDS")
...
run.gams.bydepth(input.depth.df = myelin.compartments.7T$superficial, output.df.name = "superficial_gamstatistics_age_sex.RDS")
run.gams.bydepth(input.depth.df = myelin.compartments.7T$middle, output.df.name = "middle_gamstatistics_age_sex.RDS")
run.gams.bydepth(input.depth.df = myelin.compartments.7T$deep, output.df.name = "deep_gamstatistics_age_sex.RDS")
...
fit.sexeffects.bydepth(input.depth.df = myelin.compartments.7T$superficial, output.df.name = "superficial_sex_maineffects.RDS")
fit.sexeffects.bydepth(input.depth.df = myelin.compartments.7T$middle, output.df.name = "middle_sex_maineffects.RDS")
fit.sexeffects.bydepth(input.depth.df = myelin.compartments.7T$deep, output.df.name = "deep_sex_maineffects.RDS")
...
fit.agesexinteraction.bydepth(input.depth.df = myelin.compartments.7T$superficial, output.df.name = "superficial_sex_ageinteraction.RDS")
fit.agesexinteraction.bydepth(input.depth.df = myelin.compartments.7T$middle, output.df.name = "middle_sex_ageinteraction.RDS")
fit.agesexinteraction.bydepth(input.depth.df = myelin.compartments.7T$deep, output.df.name = "deep_sex_ageinteraction.RDS")
