...
### EEG Preprocessing
EEG data were preprocessed in [McKeon et al., 2024, DCN](https://www.sciencedirect.com/science/article/pii/S1878929324000343?via%3Dihub). Code and instructions for preprocessing are available ([here](https://github.com/LabNeuroCogDevel/7T_EEG/tree/main/Preprocessing_Functions).

### EEG Source Localization and Aperiodic Activity
EEG activity was source reconstructed using each individual's cortical, scalp, and head anatomy, resulting in processed EEG timeseries in individual HCP-MMP regions. Source localization was performed in Brainstorm with ([/image_processing/EEG_aperiodic/brainstormSourceLocal.m](https://github.com/LabNeuroCogDevel/corticalmyelin_maturation/blob/main/image_processing/EEG_aperiodic/brainstormSourceLocal.m). This script includes steps to import anatomical MRIs and preprocessed EEG, project EEG channels to the scalp, compute a three-layer forward head model, calcualte the inverse process, and average vertex-level reconstructed EEG timeseries in HCP-MMP frontal regions.

The above matlab script also contains code to compute the PSD and run FOOOF to derive the aperiodic component of the PSD and associated measures (i.e., the aperiodic exponent). Frontal lobe measures of the aperiodic exponent were examined and exclusions were performed in (image_processing/EEG_aperiodic/aperiodic_glasseratlas_cleaning.R](https://github.com/LabNeuroCogDevel/corticalmyelin_maturation/blob/main/image_processing/EEG_aperiodic/aperiodic_glasseratlas_cleaning.R).
...
After defining superficial (20-30% of cortical thickness), middle (40-60%), and deep (70-80%) cortical compartments, we determined their layer correspondence based  ultra-high-resolution histological (20 micrometers) and ex-vivo MRI (120 micrometers) data. Histological layer thickness data were obtained from the [BigBrain atlas](https://github.com/caseypaquola/BigBrainWarp) and parcellated with the HCP-MMP atlas in [/results/R1_corticalmyelin_anatomy/layer_thickness/layer_thickness_parcellated.sh](https://github.com/LabNeuroCogDevel/corticalmyelin_maturation/blob/main/results/R1_corticalmyelin_anatomy/layer_thickness/layer_thickness_parcellated.sh). Ex-vivo MRI estimates of supragranular layer thickness percentage were obtained from [Zeng et al., 2024](https://academic.oup.com/cercor/article/34/9/bhae362/7755370). Code quantifying the fraction of cortical thickness occupied by different cortical layers (BigBrain) or upper layers (ex-vivo MRI) within the frontal lobe is available [here](https://htmlpreview.github.io/?https://github.com/LabNeuroCogDevel/corticalmyelin_maturation/blob/main/results/R1_corticalmyelin_anatomy/layer_thickness/frontal_laminarthickness.html).
...
Relationships between superficial and deep cortex R1 and the EEG-derived aperiodic exponent were studied in [/results/R1_EEG_relationships/R1_aperiodicactivity_associations.Rmd](https://github.com/LabNeuroCogDevel/corticalmyelin_maturation/blob/main/results/R1_EEG_relationships/R1_aperiodicactivity_associations.Rmd). This markdown presents the results of models examining the association between the aperiodic exponent and regional R1 and how the strength of this association differs between deep and superficial cortex. [A rendered version of this R markdown is available here](https://htmlpreview.github.io/?https://github.com/LabNeuroCogDevel/corticalmyelin_maturation/blob/main/results/R1_EEG_relationships/R1_aperiodicactivity_associations.html)!
