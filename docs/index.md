...
Surrogate maps (2) were created for whole-brain R1, whole-brain laminar skewness, whole-brain laminar coefficient of variation, and frontal lobe S-A axis using the [create surrogate map python scripts](https://github.com/LabNeuroCogDevel/corticalmyelin_maturation/blob/main/results/brainsmash_nulls).
