...
```{r}
gam.sexeffects.alldepths <- list(superficial_sex_maineffects, middle_sex_maineffects, deep_sex_maineffects)
names(gam.sexeffects.alldepths) <- depth.list
```

```{r}
gam.sexinteractions.alldepths <- list(superficial_sex_ageinteraction, middle_sex_ageinteraction, deep_sex_ageinteraction)
