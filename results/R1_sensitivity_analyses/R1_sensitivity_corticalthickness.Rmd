...
```{r}
setwd("/Volumes/Hera/Projects/corticalmyelin_development/gam_outputs/sensitivity_analyses/") #output from /gam_models/fit_ageGAMs_glasserregions_bydepth.R
...
gam.results.alldepths <- list(depth1_gamstatistics_age_CT, depth2_gamstatistics_age_CT, depth3_gamstatistics_age_CT, depth4_gamstatistics_age_CT, depth5_gamstatistics_age_CT, depth6_gamstatistics_age_CT, depth7_gamstatistics_age_CT)
...
frontallobe.rate.alldepths %>% 
  ...
  xlab("\nMean Derivative") +
  ylab("Cortical Depth\n") +
  scale_x_continuous(breaks = c(0.001, 0.0015), limits = c(0.00085, 0.0015)) +
  theme(
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/CT_depthplot_derivative.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/CT_%s_rate_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.16, height = 1.7)
}
```
...
ggplot(rate.SAaxis.bydepth, aes(x = SA.corr, y = depth,  fill = depth)) +
  ...
  xlab("\nS-A Axis Correlation") +
  ylab("Cortical Depth\n") +
  scale_x_continuous(breaks = c(-0.6, -0.3, 0), limits = c(-0.62, 0)) +
  scale_fill_manual(values = depth_colorbar) +
...
frontallobe.maturation.alldepths %>% 
  ...
  xlab("\nAge of Maturation") +
  ylab("Cortical Depth\n") +
  scale_x_continuous(limits = c(25.9, 30.5), breaks = c(26, 28, 30)) +
  theme(
  legend.position = "none",
  axis.text = element_text(size = 6, family = "Arial", color = c("black")),
  axis.title.x = element_text(size = 6, family ="Arial", color = c("black")),
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/CT_depthplot_maturation.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/CT_%s_maturation_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.16, height = 1.7)
}
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/CT_Area4_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/CT_Area46_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/CT_Areaa24_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4_supplementary/Clusters_CT.pdf", device = "pdf", dpi = 500, width = 3.5, height = 3.5)
```
