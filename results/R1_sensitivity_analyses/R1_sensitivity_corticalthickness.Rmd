...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure5/CT_depthplot_derivative.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure5/CT_%s_rate_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.16, height = 1.7)
}
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure5/CT_depthplot_maturation.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure5/CT_%s_maturation_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.16, height = 1.7)
}
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure5/CT_Area4_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure5/CT_Area46_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure5/CT_Areaa24_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure5_supplementary/Clusters_CT.pdf", device = "pdf", dpi = 500, width = 3.5, height = 3.5)
```
