---
title: "Myelin Development Sensitivity Analysis: Cortical Thickness"
...
files <- list.files(getwd(), pattern = "age_CT.RDS") 
...
```{r}
gam.results.alldepths <- list(superficial_gamstatistics_age_CT, middle_gamstatistics_age_CT, deep_gamstatistics_age_CT)
...
frontallobe.rate.alldepths %>% 
  ...
  scale_x_continuous(breaks = c(0.001, 0.0015), limits = c(0.001, 0.0015)) +
  theme(
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/CT_depthplot_derivative.pdf", device = "pdf", dpi = 500, width = 1.1, height = 1.3)
```
...
ggsave(filename = sprintf("/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/CT_%s_rate_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.15, height = 1.7)
}
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/CT_depthplot_maturation.pdf", device = "pdf", dpi = 500, width = 1.1, height = 1.3)
```
...
ggsave(filename = sprintf("/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/CT_%s_maturation_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.15, height = 1.7)
}
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/CT_Area4_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/CT_Area46_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/CT_Areaa24_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6_supplementary/CT_PC1_curvature.pdf", device = "pdf", dpi = 500, width = 4.3, height = 2.2)
```
