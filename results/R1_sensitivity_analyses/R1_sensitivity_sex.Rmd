...
```{r}
setwd("/Volumes/Hera/Projects/corticalmyelin_development/gam_outputs/developmental_effects/") #output from /gam_models/fit_ageGAMs_glasserregions_bydepth.R
...
gam.results.alldepths <- list(depth1_gamstatistics_age_sex, depth2_gamstatistics_age_sex, depth3_gamstatistics_age_sex, depth4_gamstatistics_age_sex, depth5_gamstatistics_age_sex, depth6_gamstatistics_age_sex, depth7_gamstatistics_age_sex)
...
frontallobe.rate.alldepths %>% 
  ...
  xlab("\nMean Derivative") +
  ylab("Cortical Depth\n") +
  scale_x_continuous(breaks = c(0.001, 0.002), limits = c(0.00085, 0.00205)) +
  theme(
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Sex_depthplot_derivative.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Sex_%s_rate_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.16, height = 1.7)
}
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Sex_depthplot_maturation.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Sex_%s_maturation_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.16, height = 1.7)
}
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Sex_Area4_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Sex_Area46_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Sex_Areaa24_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4_supplementary/Clusters_sex.pdf", device = "pdf", dpi = 500, width = 3.5, height = 3.5)
```
