---
title: "Myelin Development Sensitivity Analysis: Biological Sex"
...
```{r}
setwd("/Volumes/Hera/Projects/corticalmyelin_development/gam_outputs/developmental_effects/") #output from /gam_models/fit_sensitivityGAMs_glasserregions_bydepth.R

files <- list.files(getwd(), pattern = "age_sex.RDS") 
...
```{r}
gam.results.alldepths <- list(superficial_gamstatistics_age_sex, middle_gamstatistics_age_sex, deep_gamstatistics_age_sex)
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/Sex_depthplot_derivative.pdf", device = "pdf", dpi = 500, width = 1.1, height = 1.3)
```
...
ggsave(filename = sprintf("/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/Sex_%s_rate_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.15, height = 1.7)
}
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/Sex_depthplot_maturation.pdf", device = "pdf", dpi = 500, width = 1.1, height = 1.3)
```
...
ggsave(filename = sprintf("/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/Sex_%s_maturation_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.15, height = 1.7)
}
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/Sex_Area4_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/Sex_Area46_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6/Sex_Areaa24_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Users/valeriesydnor/Documents/ResearchProjects/CorticalMyelin_PlasticityDevelopment/Publications/Publication_Images/Figure6_supplementary/Sex_PC1_curvature.pdf", device = "pdf", dpi = 500, width = 4.3, height = 2.2)
```
