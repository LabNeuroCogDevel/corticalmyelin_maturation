---
title: "Myelin Development Sensitivity Analysis: Model Specification"
...
files <- list.files(getwd(), pattern = "age_k.RDS") 
...
gam.results.alldepths <- list(depth1_gamstatistics_age_k, depth2_gamstatistics_age_k, depth3_gamstatistics_age_k, depth4_gamstatistics_age_k, depth5_gamstatistics_age_k, depth6_gamstatistics_age_k, depth7_gamstatistics_age_k)
...
frontallobe.maturation.alldepths %>% 
  ...
  xlab("\nAge of Maturation") +
  ylab("Cortical Depth\n") +
  scale_x_continuous(limits = c(24, 30.5)) +
  theme(
  legend.position = "none",
  axis.text = element_text(size = 6, family = "Arial", color = c("black")),
  axis.title.x = element_text(size = 7, family ="Arial", color = c("black")),
...
scale_fill_gradientn(colors = c("white", "#CCDCED", "#BFD2E2", "#7B9FC6"), limits = c(0.2, 1))
```
...
ggplot(maturation.SAaxis.bydepth, aes(x = SA.corr, y = depth,  fill = depth)) +
  ...
  xlab("\nS-A Axis Correlation") +
  ylab("Cortical Depth\n") +
  scale_x_continuous(breaks = c(0, .1, .2, .3), limits = c(0, 0.36)) +
  scale_fill_manual(values = depth_colorbar) +
  theme(axis.text.y = element_text(angle = 45, hjust = 1)) +
  theme(
        legend.position = "none", 
...
#ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure3/Area4_depthsmooths.pdf", device = "pdf", dpi = 500, width = 2.3, height = 1.8)
```
...
#ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure3/Area46_depthsmooths.pdf", device = "pdf", dpi = 500, width = 2.3, height = 1.8)
```
...
#ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure3/Areaa24_depthsmooths.pdf", device = "pdf", dpi = 500, width = 2.3, height = 1.8)
```
...
```{r}
 ...
 scale_fill_manual(values = c(depth_colorbar[6], depth_colorbar[3], depth_colorbar[2]), na.value = "white") +  
  theme(legend.position = "none", axis.text = element_blank(), axis.line = element_blank(), axis.ticks = element_blank()) +
  new_scale_fill() + 
  geom_brain(data = glasser.plotting, atlas = glasser, mapping = aes(fill = cortex),  colour=I(alpha("gray50", 0)), size=I(0)) +
  scale_fill_manual(values = c(alpha("white", 0), "gray75")) 
