...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/PVE_depthplot_derivative.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/PVE_%s_rate_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.15, height = 1.7)
}
```
...
ggplot(rate.SAaxis.bydepth, aes(x = SA.corr, y = depth,  fill = depth)) +
  ...
  xlab("\nS-A Axis Correlation") +
  ylab("Cortical Depth\n") +
  scale_x_continuous(breaks = c(-0.6, -0.3, 0), limits = c(-0.6, 0)) +
  scale_fill_manual(values = depth_colorbar) +
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/PVE_depthplot_maturation.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/PVE_%s_maturation_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.15, height = 1.7)
}
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/PVE_Area4_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/PVE_Area46_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/PVE_Areaa24_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4_supplementary/Clusters_PVE.pdf", device = "pdf", dpi = 500, width = 3.5, height = 3.5)
```
