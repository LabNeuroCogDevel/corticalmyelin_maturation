...
gam.results.alldepths <- list(depth1_gamstatistics_age_curvature, depth2_gamstatistics_age_curvature, depth3_gamstatistics_age_curvature, depth4_gamstatistics_age_curvature, depth5_gamstatistics_age_curvature, depth6_gamstatistics_age_curvature, depth7_gamstatistics_age_curvature)
...
frontallobe.rate.alldepths %>% 
  ...
  xlab("\nMean Derivative") +
  ylab("Cortical Depth\n") +
  scale_x_continuous(breaks = c(0.001, 0.002), limits = c(0.0009, 0.0021)) +
  theme(
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Curvature_depthplot_derivative.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Curvature_%s_rate_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.15, height = 1.7)
}
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Curvature_depthplot_maturation.pdf", device = "pdf", dpi = 500, width = 1.3, height = 1.3)
```
...
ggsave(filename = sprintf("/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Curvature_%s_maturation_corticalmap.pdf", this.depth), device = "pdf", dpi = 500, width = 3.15, height = 1.7)
}
```
...
scale_fill_gradientn(colors = c("white", "#CCDCED", "#BFD2E2", "#7B9FC6"), limits = c(0.25, 1))
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Curvature_Area4_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Curvature_Area46_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4/Curvature_Areaa24_depthsmooths.pdf", device = "pdf", dpi = 500, width = 1.5, height = 1.4)
```
...
ggsave(filename = "/Volumes/Hera/Projects/corticalmyelin_development/Figures/Figure4_supplementary/Clusters_curvature.pdf", device = "pdf", dpi = 500, width = 3.5, height = 3.5)
```
